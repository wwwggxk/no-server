 ...
 *
 * Issues:
 * 1. filename of parent module is confused when requiring module and it's parent
...
var Server = (function () {
    ...
    function S(root, options) {
        ...
        if (!isAbsolute) {
            // TODO: more elegant way to fix issues 1
            isFromIndex = module.parent.filename.indexOf('/no_server/index.js') > -1;
            relativePath = isFromIndex ?
                            module.parent.parent.filename :
                            module.parent.filename;
            defaults.root = path.join(path.dirname(relativePath), defaults.root);
        }
